                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="select2 form-control @error('project_id') is-invalid @enderror" id="project_id"
                                ...
                                @foreach ($projects as $item)
                                    <option class="text-capitalize" {{ $task->project_id == $item->id ? 'selected' : '' }}
                        ...
                        <div class="mb-3">
                            ...
                            <select class="select2 form-control @error('priority') is-invalid @enderror" id="priority"
                                name="priority">
                                <option class="text-capitalize" {{ $task->priority == 'low' ? 'selected' : '' }}
                                    value="low">Low</option>
                                <option class="text-capitalize" {{ $task->priority == 'medium' ? 'selected' : '' }}
                                    value="medium">Medium
                                </option>
                                <option class="text-capitalize" {{ $task->priority == 'high' ? 'selected' : '' }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="deadline" name="deadline"
                                ...
                                value="{{ old('deadline') ? old('deadline') : $task->deadline }}">
                            @error('deadline')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="tim" name="tim"
                                class="form-control @error('tim') is-invalid @enderror"
                                value="{{ old('tim') ? old('tim') : $task->tim }}">
                            @error('tim')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
